...
public final class Constants {
    ...
    // Auto Setup
    public static final double AUTO_TRAVEL_SPEED = 0.3; // Don't put above 0.75, needs some room for turning corrections
    // Gear Ratios
    ...
    public static final double TURN_PS_TOLERANCE = 1f;
    // Shooter PID Setup
